    ...
    View.prototype  = {
        ...
        canvasExtension : {
            ...
            _updateTransition:function () {
                ...
                [].forEach.call(this.swapText, function (particle, index) {

                    if (!self.particles[index].interactive) {

                        self.particles[index].x += ((particle.x + Math.cos(particle.angle + index) * particle.orbit) - self.particles[index].x) * 0.08;
            ...
            _update:function () {
                ...
                [].forEach.call(this.particles, function (particle, index) {
                    ...
                    if(distanceTo(self.mouse, particle) <= 10)
